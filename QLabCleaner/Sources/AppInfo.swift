...
enum AppInfo {
    ...
    static let githubURL = URL(string: "https://github.com/desertdognl/qlab-cleaner")!
    static let githubReleasesURL = URL(string: "https://github.com/desertdognl/qlab-cleaner/releases")!
}
